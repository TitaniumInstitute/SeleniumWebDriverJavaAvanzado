...
public class EjemploSoftHardAssert {
    ...
    @Test(description = "Creación de una clase", dataProvider = "SchoolProvider", enabled = false)
    ...
    void testToCreateClass(String ... classInfo){
        ...
        softAssert.assertEquals(classInfo[0], txtClassName.getAttribute("value"));
    ...
    void testToCreateSubject(String className, String subjectName, String subjectCode, String subjectTeacher, String bookName){
        ...
        txtSubjectCode.sendKeys(subjectCode);
