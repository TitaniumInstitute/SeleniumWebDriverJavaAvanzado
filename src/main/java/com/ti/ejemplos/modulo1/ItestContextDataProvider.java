...
public class ItestContextDataProvider {
        ...
        for (String group:groupContext.getIncludedGroups()) {
            if (group.equals("Smoke")){
                ...
                groupArray = new Object[][]{
                        ...
                        {"wpsp standard-3", "Computer Science", "CS002", "Adam Hodgson", "Introduction to Computer Science"}
                };
            }
            break;
        }
    ...
    @Test(description = "Creación de una clase", dataProvider = "SchoolProvider", groups = "Smoke")
